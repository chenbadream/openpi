...
class LeRobotXhandDataConfig(DataConfigFactory):
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        data_transforms = _transforms.Group(
            inputs=[xhand_policy.XhandInputs(action_dim=model_config.action_dim, model_type=model_config.model_type)],
            outputs=[xhand_policy.XhandOutputs()],
        )
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi0_xhand_low_mem_finetune",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotXhandDataConfig(
            repo_id="Chenba/xhand_sim",
            base_config=DataConfig(
