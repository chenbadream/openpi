...
class XhandInputs(transforms.DataTransformFn):
    """
    ...
    def __call__(self, data: dict) -> dict:
        ...
        base_image = _parse_image(data["image1"])
        wrist_image = _parse_image(data["image2"])
        ...
        if "prompt" in data:
            ...
            inputs["prompt"] = data["text"]

        return inputs


@dataclasses.dataclass(frozen=True)
class XhandOutputs(transforms.DataTransformFn):
    """
